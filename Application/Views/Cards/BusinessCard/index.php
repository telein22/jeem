...
<table
        id="content"
        style="min-height: 500px;width: 400px;border-spacing: 0; margin: 0 auto; background-color: #00738F;  padding: 30px;">
    <tr>
            ...
            <table style="background: url(<?= URL::asset('/Application/Assets/business_card_and_poster/shape.png') ?>) no-repeat ,#fff; background-size: 100%; background-position:100px center ; width: 100%;padding: 30px; border-radius: 35px; border-bottom-right-radius: 0;">
                ...
                <tr>
                    <td style="text-align: center; padding: 30px 0;">
                        <h1 style="margin: 5px 0;font-size: 32px; font-weight: bold; color: #08748f;"><?=  $user['name']; ?></h1>
                ...
                <tr style=" text-align: center;">
                    ...
                    height: 130px;">
                        <p style="font-size: 16px; font-weight: 400; color: #08748f; margin-top: 0px; margin-bottom: 0;"><?= $user['username'] ?>@</p>
                    </td>
